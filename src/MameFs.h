...
private:
  ...
  static NTSTATUS SGetSecurityByName(FSP_FILE_SYSTEM *FileSystem,
  ...
  static std::wstring m_ZipPrefix;
  static std::wstring m_SevenZipPrefix;
  static bool m_Enable7z;
  static bool m_DebugMode;

  static std::wstring GetLocalPath(PCWSTR fileName);

  // Helper to check if filename has valid basename (not empty before extension)
  static bool HasValidBasename(const std::wstring &fileName);
};
